...
/**
 * This program displays 100 copies of a message.  The color and 
...
public class RandomStrings extends Application {
	...
	private final static String MESSAGE = "Hello Gitters"; 
    ...
    public void start( Stage stage ) {
        ...
        redraw.setOnAction( e -> draw() ); //redraw the canvas once clicked.
     ...
     * It draws 100 copies of the message string, using a random color, font, and
     * position for each string.
     */
    private void draw() {

        GraphicsContext g = canvas.getGraphicsContext2D(); //you need this in order to draw on a canvas.
        
        double width = canvas.getWidth();
        double height = canvas.getHeight();
        
        g.setFill( Color.WHITE );  // fill the canvas with white background
        ...
        for (int i = 0; i < 100; i++) {
            ...
            g.setStroke(Color.BLACK); //set first the color of stroking.
            g.strokeText(MESSAGE,x,y); //now stroke the message
