...
public class DemoTrackMouse extends Application {
    ...
    private void mouseEventOnCanvas(MouseEvent evt, String eventType) {
        //append the type of event that happens.
    	eventInfo.append(eventType + " on canvas at (");
        
    	//append the position of the mouse during the event by returning its coordinates (x,y) type casted into int.
