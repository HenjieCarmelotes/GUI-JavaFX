 ...
 * a "boat" (a green roundrect).  The user moves the boat with the left- and 
...
public class ArcadeSubKiller extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Submarine Annihalator -- Use arrow keys to play!");
        ...
        } //end of anonymous subclass of AnimationTimer
        ;
     ...
     * draws a gray border(means the input focus is inactive) or cyan border(means the input focus is active)
     * It draws the boat, sub, and bomb by
    ...
    public void draw() {
        ...
        g.setFill(Color.rgb(0,0,180)); // Fill the canvas with green, erasing previous frame. (because it is called 60 times)
    ...
    private class Boat {
        ...
        void updateForNewFrame() { // This method is making sure that the boat has not moved off screen.
            if (centerX < 0)
                centerX = 0;
    ...
    private class Bomb {
        ...
        void updateForNewFrame() {  // Method responsible if bomb is falling, take appropriate action.
            if (isFalling) {
                if (centerY > height) {
        ...
        void updateForNewFrame() { // Move sub or increase explosionFrameNumber.
            if (isExploding) {
                ...
                if (explosionFrameNumber == 25) { 
                    ...
                    isExploding = false;
                    isMovingLeft = (Math.random() < 0.5);
                    //System.out.println(explosionFrameNumber);
                }
            }
            else { // Move the sub.
                if (Math.random() < 0.02) {  
