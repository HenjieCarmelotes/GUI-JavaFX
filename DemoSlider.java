...
public class DemoSlider extends Application {

    private Slider slider1, slider2, slider3, slider4;  // The sliders.
    ...
    public void start(Stage stage) {
        ...
        /*Slider1 - no decorations*/

        slider1 = new Slider(0,10,5);  //first parameter is start, second param is end, third param is initial value during the show...
        
        
        /*Slider2 - with tick decorations */
        ...
        /*Slider2 - with label decorations */
        ...
        slider3.setShowTickLabels(true);  // will show labels at 2000, 2050, 2100 (shows in integers.)
        ...
        /* Slider4 - make it vertical */
        
        
        slider4 = new Slider(25,100,50); 
        slider4.setOrientation(Orientation.VERTICAL);
        
        
        /*Sliders don't generate ActionEvent, instead they have observable property of type double.*/
        ...
        slider4.valueProperty().addListener( e -> sliderValueChanged(slider4) );
        
        VBox root = new VBox(12,label,slider1,slider2,slider3, slider4);
        root.setStyle("-fx-background-color:white; -fx-border-color: black");
        root.setPadding( new Insets(15) );
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.setTitle("Simple Slider Demonstration");
        stage.show();
    ...
    private void sliderValueChanged(Slider whichSlider) {
        ...
        else if (whichSlider == slider4)
            str = String.format("Fourth slider value is now %1.2f", slider4.getValue());
        else
