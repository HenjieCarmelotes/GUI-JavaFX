...
public class TextCounter extends Application {
    ...
    public void start(Stage stage) {
        ...
        HBox button = new HBox(10, countButton, clearButton);
        button.setAlignment(Pos.CENTER);
        

        VBox root = new VBox( 4, textInput, button,
    ...
    private void doClear() {
        textInput.setText("Input some text again. ");
        textInput.selectAll();
        textInput.requestFocus();
        lineCountLabel.setText("  Number of lines:  0");
        wordCountLabel.setText("  Number of words:  0");
        charCountLabel.setText("  Number of chars:  0");
    }
    ...
    public void processInput() {
        ...
        /* Compute the wordCt by counting the number of characters
              ...
              preceded by a letter, then its not the first character
              in a word.
         */
