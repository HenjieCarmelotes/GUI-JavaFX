...
public class PaneDemo extends Application {
     ...
     * but not the buttons, which it ignores. [But you can adjust the window since by default, it is adjustable])
     */
    public void start(Stage stage) {
        ...
        /* Set the location of each child by calling its relocate() method. Without this,
         * they will all appear with their top left corners at the default location, (0,0)!) */
         ...
         * their sizes just to fit on the window.. */
        ...
        //Pane root = new Pane(board, newGameButton, resignButton, message); -> Alternative call but must remove the .getChildren() on the 101 line.
        Pane root = new Pane();
        ...
        stage.setTitle("Sample Pane Layout");
        stage.show();
