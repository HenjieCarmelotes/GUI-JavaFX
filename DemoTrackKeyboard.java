...
/**
 * This program demonstrates processing of KeyEvents.  A colored rounded-square
 ...
 * of the square is drawn.  Pressing the space bar returns the rounded-square
 * to its original color, fill, and position.  When the SHIFT key is down, 
 * a thick cyan border is drawn around the canvas.
 */


public class DemoTrackKeyboard extends Application {
    ...
    private Color squareColor = Color.RED;  // The default color of the square.
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Keyboard Event Demonstration");
        stage.setResizable(false);
        
        scene.setOnKeyPressed( e -> keyPressed(e) );
        scene.setOnKeyTyped( e -> keyTyped(e) );
        scene.setOnKeyReleased(this::keyReleased); //if the number of parameter is the same as the number of parameter in the 
        											//interface, use this to refer to the object being used.
        stage.show();
    }
    ...
    private void keyTyped(KeyEvent evt) {
        ...
        System.out.println("Character Typed: " + ch);  // for testing
    ...
    private void keyPressed(KeyEvent evt) { 
        ...
        if (key == KeyCode.LEFT) {  // left arrow key
            squareLeft -= 10; //reduce the coordinates to 10.
            if (squareLeft < 3)
                squareLeft = 3;
            draw(); 
        }
            ...
            squareTop -= 10; //reduce the coordinates to 10.
            if (squareTop < 3)
                squareTop = 3;
            draw();
        }
    ...
    /**
     * Draws a rounded-square, message and maybe a border in the canvas.  The border
    ...
    public void draw() {
        ...
        if (filled) {
            ...
            g.fillRoundRect(squareLeft, squareTop, SQUARE_SIZE, SQUARE_SIZE, SQUARE_SIZE/3, SQUARE_SIZE/3);
        }
        else {
        ...
        g.setFill(squareColor == Color.BLACK ? Color.MAGENTA : Color.BLACK); //check first if the filled shape color does not
        																	//contrast the color of text.
        
        g.fillText("Arrow Keys Move Square.\n" +
                        "k,r,g,b change color and fill the rounded-square.\n" +
                        "K,R,G,B change color and outline the rounded-square.\n"+
...
} //end of class DemoTrackKeyboard
